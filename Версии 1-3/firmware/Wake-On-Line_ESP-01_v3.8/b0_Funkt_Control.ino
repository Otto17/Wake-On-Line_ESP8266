...
void PageInfo() {
  ...
  String webInfo2 = "<strong style=\"color:#0000FF\">Uptime:&nbsp;</strong>" + TimeUptime + "<br><strong style=\"color:#0000FF\">Частоту FLASH:&nbsp;</strong>" + FlashChipSpeed + "&nbsp;МГц<br><strong style=\"color:#0000FF\">Частоту CPU:&nbsp;</strong>" + CpuFreqMHz + "&nbsp;МГц<br><br><strong style=\"color:#0000FF\">Свободно ОЗУ:&nbsp;</strong>" + FreeHeap + "&nbsp;байт<br><br><strong style=\"color:#0000FF\">Размер FLASH:&nbsp;</strong>" + FlashChipSize + "&nbsp;байт<br><strong style=\"color:#0000FF\">Реальный размер FLASH:&nbsp;</strong>" + FlashChipRealSize + "&nbsp;байт<br><strong style=\"color:#0000FF\">Свободно FLASH:&nbsp;</strong>" + FreeSketchSpace + "&nbsp;байт<br><br><strong style=\"color:#0000FF\">Фрагментация кучи:&nbsp;</strong>" + HeapFragmentation + "&nbsp;% (более 50% ПЛОХО)<br><strong style=\"color:#0000FF\">Неудачных авторизаций:&nbsp;</strong>" + eroorAuthoriz + "&nbsp;раз<br><strong style=\"color:#0000FF\">Причина сброса питания:&nbsp;</strong>" + ResetReason + "<br><br><strong style=\"color:#0000FF\">MAC адрес:&nbsp;</strong>" + myMAC + "<br><strong style=\"color:#0000FF\">BSSID:&nbsp;</strong>" + myBSSID + "<br><strong style=\"color:#0000FF\">HOSTNAME:&nbsp;</strong>" + host_Name + "<br><br><strong style=\"color:#0000FF\">Chip ID ESP8266:&nbsp;</strong>" + ChipId + "<br><strong style=\"color:#0000FF\">Chip ID FLASH:&nbsp;</strong>" + FlashChipId + "<br><strong style=\"color:#0000FF\">Версия SDK ESP:&nbsp;</strong>" + CoreVersion + "<br><br><strong style=\"color:#0000FF\">Версия прошивки:&nbsp;</strong>" + ver + "</body></html>";
...
void PageReboot() {
  ...
  delay(200);     // Ждём догрузки страницы "Загрузка..."
  ESP.restart();  // Перезагружаем ESP-01
  delay(2000);    // Задержка для стабильности (без неё не всегда срабатывает перезагрузка)
}
